...
const gatewayAllowedRoutes: readonly GatewayRoute[] = [
  ...
  { pattern: new RegExp(`^/v1/recipients/${ID_SEGMENT}$`), methods: ["PATCH", "DELETE"], access: "session", routeClass: "recipients" },
...
const safeResponseHeaders = new Set(["content-type", "retry-after", "x-csrf-token"]);
