  ...
  return <div className="mx-auto max-w-5xl">
    ...
    <div className="grid gap-6 lg:grid-cols-[1fr_0.78fr] lg:items-start">
      ...
      <aside className="space-y-4 lg:sticky lg:top-24">
        ...
        <div className="grid grid-cols-2 gap-2"><Action onClick={() => navigate(`/shipments/${shipment.id}/proof`)} icon={<FileCheck2 className="size-4" />} label="Proof of delivery" compact /><Action onClick={() => toast.success("Receipt download prepared.")} icon={<Download className="size-4" />} label="Receipt" compact /></div>
      </aside>
    </div>
