...
import { useCustomerSupportCases, useFileUploadIntentMutation, useSupportCaseMutation } from "@/api/hooks";
...
export default function Support() {
  ...
  return <div className="mx-auto max-w-3xl text-ink">
    ...
    {createCase.isError && <div className="mt-5 rounded-2xl border border-ink/15 bg-white p-4 text-sm text-ink/70">We could not create the support case. Please try again.</div>}
